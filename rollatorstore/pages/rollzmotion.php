...
<head>
	...
	<title>Rollatorstore - Rollz motion</title>
</head>
	...
	<div id="wrapper">
		...
		<div id="nav">
			<nav>
				...
				><a href="accessoires.php"><img src="../images/menu/accessoires.png"></a
				><a href="algemene_informatie.php"><img src="../images/menu/algemeneinformatie.png"></a>
			</nav>
		...
		<div id="content">	
			<div id="producten">
				<a class="terug_link" href="producten.html">&laquo;  Terug naar productenoverzicht</a><br>
                     <div id="product_info">
					<h2>Rollz motion</h2>
					<p class="text_product">Rollz Motion, d&#233; rollator van de nieuwe generatie! 
					De Rollz Motion biedt de gelegenheid om verder te komen door een serie van 
					slimme en innovatieve eigenschappen.</p>
				...
				<aside>
					...
					<div id="prijs"><img src="../images/producten/rollz_motion_prijs.png"></a></div>
					<p class="text_product">
 voordeel: <b>10%</b></p><br>
					
					<!--<a href="winkelmandje.html"><div id="button_toevoegen_winkelmandje"></div></a>-->
        ...
        <ul class="mytabs" id="tabs">
           <!-- <li class="current"><a href="./tabs/tab-2.html">Tab 2</a></li>
			...
			<li class="help"><a href="jav/tabs/eigenschappen.html">Specificaties</a></li>
			<li><a href="jav/tabs/rollz.php?id=3">Beschrijving</a></li>
			<li><a href="jav/tabs/testie.html">Afbeeldingen</a></li> 
