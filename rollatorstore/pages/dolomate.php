...
<body>
	<div id="wrapper">
		...
		<div id="content">	
			<div id="producten">
				<a class="terug_link" href="producten.php"> &laquo;  Terug naar productenoverzicht</a><br>
				                                          <?php
                                                                //producten($_GET['id']); 
				...
				<div id="product_info">
					<h2>Dolomite Jazz </h2>
					<p class="text_product">De Dolomite Jazz rollator is de nieuwste rollator gebruik te maken van cross-vouwen-technologie. 
					Een stijlvol design met slimme functies en zorgvuldig doordacht, goed ontworpen componenten maken de Dolomieten Jazz een winnaar. 
					Met indrukwekkende aanpassing mogelijkheden en ergonomie, in combinatie met een ingebouwd remsysteem, de Dolomieten Jazz heeft vele geweldige functies die dit product uniek maakt.</p>
<u><b><i>U MOET DE BESCHRIJVING EERST LEZEN VOORDAT U VERDER GAAT.</i></b></u>

				
				</div>
			 
				<aside>
					<div id="product_foto_domolite">
					</div>
					<div id="prijs"><img src="../images/producten/dolomate-price.gif"></a></div>
        ...
        <ul class="mytabs" id="tabs">
           <!-- <li class="current"><a href="./tabs/tab-2.html">Tab 2</a></li>
			...
			<li class="help"><a href="jav/dolomate/eigenschappen.html">Specificaties</a></li>
			<li><a href="jav/dolomate/dolomate.php?id=76">Beschrijving</a></li> 
			<li><a href="jav/dolomate/testie.html">Afbeeldingen</a></li> 
