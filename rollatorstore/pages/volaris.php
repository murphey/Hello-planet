		...
		<div id="content">	
			<div id="producten">
				<a class="terug_link" href="producten.php"> &laquo;  Terug naar productenoverzicht</a><br>
                                                     ...
                                                     ?>
				<div id="product_info">
					<h2>Volaris-S7-Smart</h2>
					<p class="text_product">
					De rollator Volaris S7 is speciaal voor mensen met vermindering van spierkracht.
 De remmen van deze rollator zijn eenvoudig en licht te bedienen. 
De Volaris S7 Smart is een lichtgewicht rollator en geschikt voor binnen en buitenshuis. </p><br>
<u><b><i>U MOET DE BESCHRIJVING EERST LEZEN VOORDAT U VERDER GAAT.</i></b></u>
				...
				<aside>
					<div id="product_foto_volaris">
					</div>
					<div id="prijs"><img src="../images/producten/volaris-price.gif"></a></div>
        ...
        <ul class="mytabs" id="tabs">
           <!-- <li class="current"><a href="./tabs/tab-2.html">Tab 2</a></li>
			...
			<li class="help"><a href="jav/volaris/eigenschappen.html">Specificaties</a></li>
			<li><a href="jav/volaris/volaris.php?id=60">Beschrijving</a></li>
			<li><a href="jav/volaris/testie.html">Afbeeldingen</a></li> 
