	...
	<div id="wrapper">
		...
		<div id="content">	
			<div id="producten">
				...
				<div id="product_info">
					...
					Eettafeltje waar u uw eten en drinken makkelijk kunt neerzetten. De rollator heeft een handige draagtas onder het tafeltje.</p>

				
				</div>
			
				<aside>
					<div id="product_foto_activelight">
					</div>
					<div id="prijs"><img src="../images/producten/active_light_prijs.png"></a></div>
        ...
        <ul class="mytabs" id="tabs">
           <!-- <li class="current"><a href="./tabs/tab-2.html">Tab 2</a></li>
			...
			<li class="help"><a href="jav/active/eigenschappen.html">Specificaties</a></li>
			<li><a href="jav/active/active.php?id=40">Beschrijving</a></li>
			<li><a href="jav/active/testie.html">Afbeeldingen</a></li> 
